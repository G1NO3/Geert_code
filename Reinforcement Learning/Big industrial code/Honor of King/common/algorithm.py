...
### 11.20 night
### Main adjust:
### Delete layer 256 for two heros and layer 64 for all soldiers
### split the two organs into two (batch x 16) matrix rather than maxpool which may influence the judgement of the model
### all of the above adjusts can be found with "###" as the keyword for search
...
##### Delete a layer 256
                ...
                fc3_hero_weight = self._fc_weight_variable(
                    shape=[512, 128], name="fc3_hero_emy_weight"
                )
                fc3_hero_bias = self._bias_variable(
                    shape=[128], name="fc3_hero_emy_bias"
                )
                fc3_hero_result = tf.add(
                    tf.matmul(fc1_hero_result, fc3_hero_weight),
                    fc3_hero_bias,
...
###### Delete a layer 256
                ...
                fc3_hero_weight = self._fc_weight_variable(
                    shape=[512, 128], name="fc3_hero_frd_weight"
                )
                fc3_hero_bias = self._bias_variable(
...
#####
                ...
                fc3_soldier_result = tf.add(
                    tf.matmul(fc1_soldier_result, fc3_soldier_weight),
                    fc3_soldier_bias,
...
### Express the two organs respectively
                fc3_organ_weight = self._fc_weight_variable(
                    shape=[64, 16], name="fc3_organ_1_weight"
                )
                fc3_organ_bias = self._bias_variable(
                    shape=[16], name="fc3_organ_1_bias"
                )
            ...
            reshape_frd_organ = tf.reshape(
                organ_1_concat_result, shape=[-1, 1, 32, 1], name="reshape_frd_organ"
            )
...
### Express the two organs respectively
                fc3_organ_weight = self._fc_weight_variable(
                    shape=[64, 16], name="fc3_organ_2_weight"
                )
                fc3_organ_bias = self._bias_variable(
                    shape=[16], name="fc3_organ_2_bias"
                )
                fc3_organ_result = tf.add(
                    tf.matmul(fc2_organ_result, fc3_organ_weight),
                    fc3_organ_bias,
            ...
            reshape_emy_organ = tf.reshape(
                organ_2_concat_result, shape=[-1, 1, 32, 1], name="reshape_emy_organ"
            )
